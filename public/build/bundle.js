    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h3, file$1, 280, 8, 7163);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$1, 284, 8, 7239);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t0 = text("FPS: ");
    			t1 = text(/*fps*/ ctx[1]);
    			attr_dev(p, "class", "fps svelte-utg1t1");
    			add_location(p, file$1, 313, 12, 8216);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(video, file$1, 288, 8, 7371);
    			...
    			add_location(canvas0, file$1, 293, 8, 7552);
    			attr_dev(canvas1, "width", wt);
    			attr_dev(canvas1, "height", ht);
    			set_style(canvas1, "display", "none");
    			add_location(canvas1, file$1, 298, 8, 7725);
    			attr_dev(button0, "class", "button1-1");
    			add_location(button0, file$1, 306, 16, 7932);
    			attr_dev(button1, "class", "button1-2");
    			add_location(button1, file$1, 307, 16, 8010);
    			attr_dev(div0, "class", "button-controller svelte-utg1t1");
    			add_location(div0, file$1, 305, 12, 7884);
    			if (!src_url_equal(img.src, img_src_value = "images/blake.JPG")) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "blake");
    			set_style(img, "height", "4rem");
    			set_style(img, "width", "5rem");
    			add_location(img, file$1, 310, 12, 8102);
    			attr_dev(div1, "class", "controller svelte-utg1t1");
    			add_location(div1, file$1, 303, 8, 7846);
    			attr_dev(div2, "class", "viewport svelte-utg1t1");
    			set_style(div2, "grid-area", "1 / 1 / 2 / 3");
    			add_location(div2, file$1, 278, 4, 7077);
    			attr_dev(input0, "class", "effect-toggle svelte-utg1t1");
    			attr_dev(input0, "type", "checkbox");
    			attr_dev(input0, "id", "tgl-filter");
    			add_location(input0, file$1, 320, 8, 8374);
    			attr_dev(label0, "class", "tgl-btn svelte-utg1t1");
    			attr_dev(label0, "for", "tgl-filter");
    			attr_dev(label0, "data-tg-off", "filter");
    			attr_dev(label0, "data-tg-on", "filter!");
    			add_location(label0, file$1, 322, 8, 8485);
    			attr_dev(div3, "class", "effect-inner svelte-utg1t1");
    			add_location(div3, file$1, 324, 8, 8596);
    			attr_dev(div4, "class", "effect svelte-utg1t1");
    			attr_dev(div4, "id", "eff-filter");
    			set_style(div4, "grid-area", "2 / 1 / 3 / 3");
    			add_location(div4, file$1, 319, 4, 8296);
    			attr_dev(input1, "class", "effect-toggle svelte-utg1t1");
    			attr_dev(input1, "type", "checkbox");
    			attr_dev(input1, "id", "tgl-ghost");
    			add_location(input1, file$1, 350, 8, 9409);
    			attr_dev(label1, "class", "tgl-btn svelte-utg1t1");
    			attr_dev(label1, "for", "tgl-ghost");
    			attr_dev(label1, "data-tg-off", "ghost");
    			attr_dev(label1, "data-tg-on", "ghost!");
    			add_location(label1, file$1, 352, 8, 9518);
    			attr_dev(div5, "class", "effect-inner svelte-utg1t1");
    			add_location(div5, file$1, 354, 8, 9626);
    			attr_dev(div6, "class", "effect svelte-utg1t1");
    			attr_dev(div6, "id", "eff-ghost");
    			set_style(div6, "grid-area", "1 / 3 / 2 / 5");
    			add_location(div6, file$1, 349, 4, 9332);
    			attr_dev(input2, "class", "effect-toggle svelte-utg1t1");
    			attr_dev(input2, "type", "checkbox");
    			attr_dev(input2, "id", "tgl-chroma");
    			add_location(input2, file$1, 380, 8, 10442);
    			attr_dev(label2, "class", "tgl-btn svelte-utg1t1");
    			attr_dev(label2, "for", "tgl-chroma");
    			attr_dev(label2, "data-tg-off", "chroma");
    			attr_dev(label2, "data-tg-on", "chroma!");
    			add_location(label2, file$1, 382, 8, 10553);
    			attr_dev(div7, "class", "effect-inner svelte-utg1t1");
    			add_location(div7, file$1, 384, 8, 10664);
    			attr_dev(div8, "class", "effect svelte-utg1t1");
    			attr_dev(div8, "id", "eff-chroma");
    			set_style(div8, "grid-area", "2 / 3 / 3 / 4");
    			add_location(div8, file$1, 379, 4, 10364);
    			attr_dev(input3, "class", "effect-toggle svelte-utg1t1");
    			attr_dev(input3, "type", "checkbox");
    			attr_dev(input3, "id", "tgl-movey");
    			add_location(input3, file$1, 396, 8, 11034);
    			attr_dev(label3, "class", "tgl-btn svelte-utg1t1");
    			attr_dev(label3, "for", "tgl-movey");
    			attr_dev(label3, "data-tg-off", "movey");
    			attr_dev(label3, "data-tg-on", "movey!");
    			add_location(label3, file$1, 398, 8, 11143);
    			attr_dev(div9, "class", "effect-inner svelte-utg1t1");
    			add_location(div9, file$1, 400, 8, 11251);
    			attr_dev(div10, "class", "effect svelte-utg1t1");
    			attr_dev(div10, "id", "eff-movey");
    			set_style(div10, "grid-area", "2 / 4 / 3 / 5");
    			add_location(div10, file$1, 395, 4, 10957);
    			attr_dev(input4, "class", "effect-toggle svelte-utg1t1");
    			attr_dev(input4, "type", "checkbox");
    			attr_dev(input4, "id", "tgl-pixel");
    			add_location(input4, file$1, 412, 8, 11620);
    			attr_dev(label4, "class", "tgl-btn svelte-utg1t1");
    			attr_dev(label4, "for", "tgl-pixel");
    			attr_dev(label4, "data-tg-off", "pixel");
    			attr_dev(label4, "data-tg-on", "pixel!");
    			add_location(label4, file$1, 414, 8, 11729);
    			attr_dev(div11, "class", "effect-inner svelte-utg1t1");
    			add_location(div11, file$1, 416, 8, 11837);
    			attr_dev(div12, "class", "effect svelte-utg1t1");
    			attr_dev(div12, "id", "eff-pixel");
    			set_style(div12, "grid-area", "1 / 5 / 2 / 6");
    			add_location(div12, file$1, 411, 4, 11543);
    			attr_dev(input5, "class", "effect-toggle svelte-utg1t1");
    			attr_dev(input5, "type", "checkbox");
    			attr_dev(input5, "id", "tgl-poster");
    			add_location(input5, file$1, 428, 8, 12206);
    			attr_dev(label5, "class", "tgl-btn svelte-utg1t1");
    			attr_dev(label5, "for", "tgl-poster");
    			attr_dev(label5, "data-tg-off", "poster");
    			attr_dev(label5, "data-tg-on", "poster!");
    			add_location(label5, file$1, 430, 8, 12317);
    			attr_dev(div13, "class", "effect-inner svelte-utg1t1");
    			add_location(div13, file$1, 432, 8, 12428);
    			attr_dev(div14, "class", "effect svelte-utg1t1");
    			attr_dev(div14, "id", "eff-poster");
    			set_style(div14, "grid-area", "2 / 5 / 3 / 6");
    			add_location(div14, file$1, 427, 4, 12128);
    			attr_dev(div15, "class", "backdrop svelte-utg1t1");
    			add_location(div15, file$1, 276, 0, 7049);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(script, "load", /*init*/ ctx[24], false, false, false, false),
